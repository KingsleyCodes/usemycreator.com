      ...
      <div className="bg-white rounded-[2.5rem] w-full max-w-lg p-8 relative animate-in fade-in zoom-in duration-200 shadow-2xl">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-black uppercase italic tracking-tighter">
            Transmit <span className="text-[#22c55e]">Deliverables.</span>
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {links.map((link, index) => (
              <div key={index} className="flex gap-2 group">
                <div className="relative flex-1">
                  <Link2 className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-300 group-hover:text-[#22c55e] transition-colors" />
                  <input
                    type="url"
                    required
                    placeholder="Paste social link here..."
                    className="w-full pl-12 p-4 bg-gray-50 border-none rounded-xl text-sm font-bold outline-none focus:ring-2 focus:ring-[#22c55e] transition-all"
                    value={link}
          ...
          <button
            ...
            className="w-full py-4 border-2 border-dashed border-gray-100 rounded-2xl text-gray-400 font-black text-[10px] uppercase tracking-widest hover:border-[#22c55e] hover:text-[#22c55e] transition-all flex items-center justify-center gap-2"
          >
          ...
          <div className="pt-6 border-t border-gray-50">
            <button
              ...
              className="w-full bg-black text-white py-5 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-[#22c55e] hover:text-black transition-all disabled:opacity-20 flex items-center justify-center gap-3 shadow-xl"
            >
