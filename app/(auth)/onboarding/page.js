      ...
      <nav className="h-16 bg-white border-b border-gray-200 flex items-center px-6 md:px-12 sticky top-0 z-50">
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => router.push("/")}>
          <div className="h-8 w-8 bg-black rounded flex items-center justify-center">
            <span className="text-[#22c55e] font-black text-sm">M</span>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-[2.5rem] overflow-hidden shadow-sm">
          <div className="p-8 md:p-12">
            <h1 className="text-3xl md:text-4xl font-serif font-medium text-gray-900 mb-4 italic">
              Join as a <span className="text-[#22c55e]">creator</span> or <span className="text-gray-400 underline">business</span>
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <button
                ...
                className="group relative flex flex-col p-8 border-2 border-gray-100 rounded-3xl hover:border-[#22c55e] hover:bg-[#22c55e]/5 transition-all text-left disabled:opacity-50"
              >
                <div className="flex justify-between items-start mb-6">
                  <Video className="h-8 w-8 text-gray-900 group-hover:text-[#22c55e] transition-colors" />
                  <div className="h-6 w-6 rounded-full border-2 border-gray-200 group-hover:border-[#22c55e] group-hover:bg-white flex items-center justify-center transition-all">
                    <div className="h-2.5 w-2.5 rounded-full bg-[#22c55e] scale-0 group-hover:scale-100 transition-transform" />
                  </div>
                </div>
